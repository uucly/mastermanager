...
public abstract class AbstractCourseButton extends AjaxButton{
	...
	protected static boolean isAlreadySelected(Prof prof, ICourse course){
		return prof.getSelectedModuls().contains(course);
	}
	
	protected static boolean isAlreadySelectedInOtherProf(Prof prof, ICourse modul, List<Prof> allProfs){
